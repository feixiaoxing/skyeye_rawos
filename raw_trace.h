...
static void _trace_queue_fp_time_record(RAW_QUEUE *p_q, RAW_VOID *p_void) {}

static void _trace_queue_ep_time_record(RAW_QUEUE *p_q, RAW_VOID *p_void) {}

static void _trace_queue_ap_time_record(RAW_QUEUE *p_q, RAW_VOID *p_void, RAW_U8 opt) {}
